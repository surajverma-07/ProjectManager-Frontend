  ...
  return (
    ...
    <div className="flex flex-wrap justify-center min-h-screen bg-gray-900 text-gray-100">
      <div className="w-full md:w-1/2 xl:w-1/3 text-center mt-32">
        ...
        {isAuthorized && 
        (isAdmin ?
          <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"><Link to={'/notice/issue'}>Issue Notice</Link></button>
          :
